...
public class GestureLockViewGroup extends RelativeLayout {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                for (int i = 0; i + 1 < mChoose.size(); i++) {
                    ...
                    //TODO 计算角度,顺时钟为正方向
                    // Math.atan2(0,10)=0   ==  degrees=0    == 对应childView需要旋转 angel=0+90 来画三角形
                    // Math.atan2(10,10)=0.7853981633974483   == degrees=45  == 对应childView需要旋转 angel=45+90 来画三角形
    ...
    private boolean checkPositionInChild(View child, int x, int y) {
        ...
        // TODO: child.getLeft()==>是获取child相对于父容器的左边的位置
     ...
     * 参考:https://www.jianshu.com/p/89efaf8bd3dd
     */
    @Override
    public void dispatchDraw(Canvas canvas) {
        super.dispatchDraw(canvas);
        // TODO: 注意亮点:
        //  1. ViewGroup中的绘制需要写到super.dispatchDraw之后,这样目的是在childView绘制完后,才进行我ViewGroup的绘制(避免被childView遮挡)
        //  2. 线相关绘制是直接在父容器中绘制了
