...
/**
 * 参考：https://blog.csdn.net/lmj623565791/article/details/23441455?spm=1001.2014.3001.5502
 */
            ...
            switch (msg.what) {
                case SCALE_REDUCE_INIT:
                    if (!isFinish) {
                        ...
                        Log.i(TAG, "SCALE_REDUCE_INIT:   s=" + s);
                        beginScale(matrix, s);
                ...
                case SCALING:
                    ...
                    if (count < 4) {
                        ...
                        if (MyImageView.this.mOnViewClickListener != null && !isClicked) {
                            ...
                            // TODO: 这是在Up的时候把点击操作复位【一次按下抬起操作是一个事件族】
                            isClicked = false;
                        }
                    }
                    count++;
